...
class RequestLeaveEdit extends StatefulWidget {
  RequestLeaveEdit({ Key key, this.data }) : super(key: key);
  dynamic data = [];

  @override
  _RequestLeaveEditState createState() => _RequestLeaveEditState();
}

class _RequestLeaveEditState extends State<RequestLeaveEdit> {
  ...
  void initState() {
    ...
    setState(() {
        ...
        reason.text = this.data['request_reason'];
        requestApproval.text = this.data['approval'];
        approval = this.data['request_approval'];
        returning.text = this.data['request_time_returning'];
        leaving.text = this.data['request_time_leaving'];
        date.text = this.data['request_date'];
        leaves = this.data['request_type'];
        this.unixNumber = this.data['number_unix'];
    });
  }
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(labelText: "Pilih pimpinan/ validator"),
                  ),
                  TextFormField(
                    controller: reason,
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Isi alasan dan tujuan anda!';
                      }
                      return null;
                    },
